...
DATA_URL = r'C:\Users\amit\Downloads\Motor_Vehicle_Collisions_-_Crashes.csv'

st.title('Motor Vehicle Collision in NYC')
st.markdown('This is a streamlit application')
...
injured_people = st.slider("No. of people injured in vehicle collision",0,19)
st.map(data.query("injured_persons >= @injured_people")[["latitude","longitude"]].dropna(how="any"))


st.header("How many collisions occur at a time?")
